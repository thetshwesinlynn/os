$(document).ready(function(){
	...
	$('.row').on('click','.view-detail',function(){
		...
		$(".btn1").attr({'data-id':id,'data-name':name,'data-photo':photo,'data-price':price,'data-discount':discount});
		...
		if (shopString) {
			...
			$.each(shopArray,function(i,v){
				...
				html += `<tr>
						...
						<td>${price_show}</td>
						<td>
						<button class="btn btn-light btn-sm min" data-item_i="${i}">-</button> 
						${qty} 
